...
void RulesetDialog::CreateControls()
{
	...
	this->txt_file_name = new wxTextCtrl( this, ID_TXT_FILE_NAME, wxString::FromAscii(timebuf), wxDefaultPosition, wxSize(200, 20) );
	...
	this->txt_support = new wxTextCtrl( this, ID_TXT_SUPPORT, wxString::FromAscii("100"), wxDefaultPosition, wxSize(70, 20) );
	...
	this->txt_confidence = new wxTextCtrl( this, ID_TXT_CONFIDENCE, wxString::FromAscii("100"), wxDefaultPosition, wxSize(70, 20) );
	...
	this->txt_improvement = new wxTextCtrl( this, ID_TXT_IMPROVEMENT,wxString::FromAscii("1"), wxDefaultPosition, wxSize(70, 20) );
	...
	this->txt_max_chi = new wxTextCtrl( this, ID_TXT_MAX_CHI, wxString::FromAscii("1"), wxDefaultPosition, wxSize(70, 20) );
	this->txt_max_chi->SetValue( wxT("1") );
	wxStaticText* lbl_max_depth = new wxStaticText( this, wxID_ANY, wxString::FromAscii("Max Depth:"));
	this->txt_max_depth = new wxTextCtrl( this, ID_TXT_MAX_DEPTH, wxString::FromAscii("3"), wxDefaultPosition, wxSize(70, 20) );
